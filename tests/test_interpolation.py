...
from prescyent.utils.interpolate import interpolate_iterable_with_ratio, interpolate_trajectory_tensor_with_ratio
...
class TestInterpolation(unittest.TestCase):
    ...
    def test_interpolate_tensor(self):
        in_tensor = torch.FloatTensor([[[1, 2, 3],[5, 4, 3]],
                                [[2, 3, 4],[4, 3, 2]],
                                [[3, 4, 5],[3, 2, 1]],
                                [[4, 5, 6],[2, 1, 0]],
                                [[5, 6, 7],[1, 0, -1]]])
        ...
        [[ 1.2000,  2.2000,  3.2000],
         [ 4.8000,  3.8000,  2.8000]],
        [[ 1.4000,  2.4000,  3.4000],
         [ 4.6000,  3.6000,  2.6000]],
        [[ 1.6000,  2.6000,  3.6000],
         [ 4.4000,  3.4000,  2.4000]],
        [[ 1.8000,  2.8000,  3.8000],
         [ 4.2000,  3.2000,  2.2000]],
        [[ 2.0000,  3.0000,  4.0000],
         [ 4.0000,  3.0000,  2.0000]],
        [[ 2.2000,  3.2000,  4.2000],
         [ 3.8000,  2.8000,  1.8000]],
        [[ 2.4000,  3.4000,  4.4000],
         [ 3.6000,  2.6000,  1.6000]],
        [[ 2.6000,  3.6000,  4.6000],
         [ 3.4000,  2.4000,  1.4000]],
        [[ 2.8000,  3.8000,  4.8000],
         [ 3.2000,  2.2000,  1.2000]],
        [[ 3.0000,  4.0000,  5.0000],
         [ 3.0000,  2.0000,  1.0000]],
        [[ 3.2000,  4.2000,  5.2000],
         [ 2.8000,  1.8000,  0.8000]],
        [[ 3.4000,  4.4000,  5.4000],
         [ 2.6000,  1.6000,  0.6000]],
        [[ 3.6000,  4.6000,  5.6000],
        ...
        [[ 4.2000,  5.2000,  6.2000],
         [ 1.8000,  0.8000, -0.2000]],
        [[ 4.4000,  5.4000,  6.4000],
         [ 1.6000,  0.6000, -0.4000]],
        [[ 4.6000,  5.6000,  6.6000],
         [ 1.4000,  0.4000, -0.6000]],
        [[ 4.8000,  5.8000,  6.8000],
         [ 1.2000,  0.2000, -0.8000]],
