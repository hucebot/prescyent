...
from prescyent.predictor.lightning.torch_lstm.module import LightningModule
from prescyent.predictor.lightning.torch_lstm.config import Config
...
class Predictor(LightningPredictor):
    ...
    def __init__(self, model_path=None, config=None):
        ...
        super().__init__(model_path, config, "TorchLSTMPredictor")
