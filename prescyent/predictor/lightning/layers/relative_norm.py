...
from prescyent.dataset.features import Feature, Rotation, Any, Coordinate, get_relative_rotation_from, get_absolute_rotation_from
...
def get_relative_tensor_from(
    ...
    for feat in tensor_features:
        ...
        # Relative for Any and Coordonate is a substraction
            ...
            input_tensor[:,:,:,feat.ids] = input_tensor[:,:,:,feat.ids] - basis_tensor[:,:,:,feat.ids]
    return input_tensor
