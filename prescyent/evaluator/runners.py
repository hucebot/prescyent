...
def pred_trajectory(trajectory: Trajectory, predictor: Callable,
                    history_size: int = 10, eval_on_last_pred: bool = False,
...
def eval_trajectory(trajectory: Trajectory,
    ...
    """
    preds, inputs = pred_trajectory(trajectory, predictor, history_size, eval_on_last_pred)
...
def pred_trajectory_multiple_predictors(trajectory: Trajectory,
    ...
    for predictor in predictors:
        preds = predictor(trajectory.scaled_tensor, history_size=history_size)
